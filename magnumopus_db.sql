...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 01-Dez-2021 às 21:52
...
INSERT INTO `produtos` (`cod_produto`, `nome_produto`, `cod_categoria`, `cod_subcategoria`, `quant_disp`, `preco`) VALUES
(2, 'Millenium Focus Junior Drum Set Black', 3, 3, 3, 15),
(3, 'Harley Benton JB-75MN Black Vintage Series', 4, 4, 4, 20);
